...
public class AccountMapperTest {
    ...
    void updateAccountFromDto_withValidData_updatesAccount() {
        ...
        existingAccount.setCustomerId(1);
        ...
        assertEquals(1, existingAccount.getCustomerId());
    }
    ...
    void toAccountFromCreateRequest_withValidData_returnsAccount() {
        ...
        createAccountRequestDTO.setCustomerId(2);
    ...
    void toAccountResponseDTOAfterUpdate_withValidData_returnsAccountResponseDTO() {
        ...
        updatedAccount.setCustomerId(3);
        updatedAccount.setAccountId(4);
        ...
        assertEquals(3, accountResponseDTO.getCustomerId());
